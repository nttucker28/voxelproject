...
public class World : MonoBehaviour
{
    ...
    //allows us to store the data about chunks that we wish to generate on our map
    Dictionary<Vector3Int, ChunkData> chunkDataDictionary = new Dictionary<Vector3Int, ChunkData>();

    //allows us to remove chunks from map
    ...
    {
        //destroys previous created chunk if have any
